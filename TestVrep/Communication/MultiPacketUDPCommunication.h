...
namespace Tribots {
  ...
  public:
    MultiPacketUDPCommunication () noexcept;
    virtual ~MultiPacketUDPCommunication () noexcept;
    ...
    virtual unsigned int send (const std::vector<char*>, const std::vector<unsigned int>) noexcept;
    /** Mehrere Pakete senden an letzten Kommunikationspartner,
        Arg1: Empfaengeradresse
        Arg2: Array mit zu sendenden Paketen
        Arg3: Array mit den Groessen der zu sendenen Pakete in Byte 
        Return: Anzahl erfolgreich gesendeter Pakete */
    virtual unsigned int sendto (const struct sockaddr_in&, const std::vector<char*>, const std::vector<unsigned int>) noexcept;
    ...
    virtual unsigned int receive (std::vector<char*>&, std::vector<unsigned int>&, unsigned int =8192) ;
    /** Alle empfangenen Pakete eines Kommunikationspartners liefern,
        ...
        Return: Anzahl erfolgreich empfangener Pakete */
    virtual unsigned int receivefrom (const struct sockaddr_in&, std::vector<char*>&, std::vector<unsigned int>&, unsigned int =8192) ;
  ...
  protected:
    ...
    virtual void receive_all (unsigned int) ;
  };
